...
public class ScreenShot extends JFrame {
    ...
    private void initControlDialog()
    {
        ...
        JLabel okLabel = new JLabel(IconUtil.getIcon(this, "/icon/zh_cn/ok.png"));
        JLabel cancelLabel = new JLabel(IconUtil.getIcon(this, "/icon/zh_cn/cancel.png"));
        JLabel downloadLabel = new JLabel(IconUtil.getIcon(this, "/icon/zh_cn/download.png"));
